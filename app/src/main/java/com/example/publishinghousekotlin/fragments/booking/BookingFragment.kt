...
//        fragmentBookingBinding.changeSearchTypeBtn.setOnClickListener {
//           fragmentBookingBinding.searchEditText.text?.clear()
//            if(statusSearching){
//                fragmentBookingBinding.searchTextInputLayout.hint = "Поиск по №"
//                fragmentBookingBinding.searchEditText.inputType = InputType.TYPE_CLASS_NUMBER
//                fragmentBookingBinding.searchEditText.keyListener = DigitsKeyListener.getInstance("0123456789")
//            }else{
//                fragmentBookingBinding.searchTextInputLayout.hint = "Поиск по статусу"
//                fragmentBookingBinding.searchEditText.inputType = InputType.TYPE_CLASS_TEXT
//            }
